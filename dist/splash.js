...
function splash(_ref) {
  var path = _ref.path,
      ...
      large = _ref.large,
      iframe = _ref.iframe,
      expressFlash = _ref.expressFlash;
  ...
  channels && channels.length === 1 && (0, _vd2.default)('span', ' #', channels[0]), ' on Slack.'), (0, _vd2.default)('p.status', active ? [(0, _vd2.default)('b.active', active), ' 人がログイン中です。', (0, _vd2.default)('b.total', total), ' が登録されています。'] : [(0, _vd2.default)('b.total', total), ' 人が近々登録されました。']), (0, _vd2.default)('form id=invite action="/invite" method="POST"', channels && (channels.length > 1
  ...
  //      )
  //    ),
  expressFlash && (expressFlash.length > 0 ? (0, _vd2.default)('button.loading disabled=1', expressFlash) : (0, _vd2.default)('button.loading', 'JOIN する。'))), (0, _vd2.default)('p.signin', 'or ', (0, _vd2.default)('a href=https://' + org + '.slack.com target=_top', 'sign in'), '.'), !iframe && (0, _vd2.default)('footer', 'powered by ', (0, _vd2.default)('a href=http://rauchg.com/slackin target=_blank', 'slackin')), style({ logo: logo, active: active, large: large, iframe: iframe }),
  // xxx: single build
